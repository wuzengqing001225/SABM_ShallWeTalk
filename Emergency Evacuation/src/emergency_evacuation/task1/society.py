...
class EscapeSociety(Society):
    ...
    def generate_env_prompt(self):
        prompt = f"""\
            Because of an earthquake, you need to escape from the room where you are as quickly as possible. If you cannot escape in 50 rounds you will die.
        ...
        short_prompt = f"""\
            You need to escape to the exit as quickly as possible. The room has a size of 33 * 33.  If you cannot escape in 50 rounds you will die.
